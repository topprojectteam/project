...
class CategorySerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        category = PublishingHouse.objects.create(name=validated_data.get(['name']), description=validated_data.get(['description']),)
        return category
...
class BookSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Book
        fields = ('id', 'title', 'description','author','cost','img_url', 'category_id', 'publishing_house_id',)
